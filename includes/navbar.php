					...
					<div class="col">
						<div class="header_content d-flex flex-row align-items-center justify-content-start">
							...
							if(isset($_SESSION['userName_back']))
							{
								...
								".$_SESSION['userName_back'];
							}
							else
							{
								echo "
								
								<div class='logo'><a href='index.php'>Sublime. 
							...
							<nav class="main_nav">
								<ul>
									<!-- <li id="hme" class="hassubs active">
								...
								$num_r = mysqli_num_rows($query_cat_result);
								...
								while($row = mysqli_fetch_assoc($query_cat_result))
								{
									...
									$query_subcat = "SELECT * FROM sub_cat where orignal_cat_id = '$cat_id' ";
									$query_subcat_result = mysqli_query($connection,$query_subcat);									
									$num_r_sub = mysqli_num_rows($query_subcat_result);
									...
									if ($num_r_sub>0)
									 {
										 echo "<script>
											...
											var element = document.getElementById('hme');
											element.classList.add('hassubs');
											element.id='$cnt';
											document.getElementById('a1').classList.add('active');
										   </script>";
										 echo "<ul `>";
										
										while($row_sub =  mysqli_fetch_assoc($query_subcat_result))

											{	$sub_cate = $row_sub['sub_ca'];
												$href = $row_sub['href'];

												$query_disp = "SELECT * FROM product where  product_cat = '$cat'";
										...
										echo "
											...
											<li><a id='$cnt' href='$href'>$sub_cate</a></li>
                                        ...
                                        $cnt++;
                                            ...
                                            // // echo "<script>
                                            // // document.getElementById('a2').addEventListener('mouseover',h1clicked);
                                            // // function h1clicked()
                                            // // {
                                            // //     document.getElementById('a2').href='home-03.php'; 
                                            // // }
								...
								<div class="shopping_cart">
									<a href="cart.php">
										...
										if(isset($_SESSION['userName_back']))
										{
											...
											$disp="SELECT * FROM cart where user_id = '$user_id'";
											$disp_res = mysqli_query($connection,$disp);
										}
										else
										{
											$disp="SELECT * FROM cart";
										}
					...
					<div class="col">
						<div class="search_panel_content d-flex flex-row align-items-center justify-content-end">
							<form action="search.php" method="POST">
								...
								<input class="search_input" list="search"  name="search"  placeholder="Search" required="required" autofocus="autofocus">
						...
						//	echo "<script> alert('$info')</script>";
							...
							while ($row = mysqli_fetch_assoc($query_disp_result))
							{
									...
									echo "<option >$product_sub_cat</option>
