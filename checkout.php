					...
					<div class="billing checkout_section">
						...
						<div class="checkout_form_container">
							<form action="#" id="checkout_form" class="checkout_form">
								...
								<div>
								<label for="checkout_country">State*</label>
									<input class="search_input" list="state"  name="state"  placeholder="State" required="required" autofocus="autofocus">

									<datalist id="state">
									<?php 
				
						//	echo "<script> alert('$info')</script>";
							$query_disp = "SELECT DISTINCT states FROM india ";
