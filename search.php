		...
		<div class="container">
			...
			<div class="row">
				<div class="col">
                    ...
                    {
                        //   echo "<script> alert('clicked connection')</script>";

                    $searchtxt = $_POST['search'];
                      // echo "<script> alert('$searchtxt')</script>";
						
					//	echo "<script> alert('$info')</script>";
						$query_disp = "SELECT * FROM product where (product_name like '%$searchtxt%')  OR (product_sub_cat like '%$searchtxt%')
                                                 OR (product_cat like '$searchtxt') limit 20";
